...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand) > 0:
        # Display the hand
        print('Your current hand is:', end = ''); displayHand(hand)
        # Ask user for input
        guess = str(input('Enter a word, or a "." to terminate:'))
        ...
        # Otherwise (the input is not a single period):
            ...
            if isValidWord(guess, hand, wordList) == False:
                ...
                print('REJECTED!!! Invalid word. DO BETTER HOOMAN!!', '\n')
    ...
    if guess == '.':
        print('PROGRAM TERMINATED - Total score:', score, ' points.')
    else:
...
def playGame(wordList):
    ...
    """
    while True:
        user_input = str(input('Please enter n to deal a new hand. Enter r to replay the last hand. Please enter e to TERMINATE:'))
        if user_input == 'e':
            break
        elif user_input == 'n':
            ...
            try:
                ...
                print('You ahve not played a hand. Please play a new hand hOOman')
            else:
